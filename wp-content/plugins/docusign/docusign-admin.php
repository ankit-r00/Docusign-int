...
<div class="wrap">
  <h2>
    <?php esc_html_e('DocuSign Account Settings', 'docusign'); ?>
  </h2>
    ...
    <table class="form-table">
      ...
      <tr valign="top">
        ...
        <td>
          ...
          value="<?php print(isset($recep_role) ? $recep_role : $fieldValues['role']); ?>"
          size="40" class="regular-text" required/>
        </td>
        <td>
          <h6>*Recipient role should be same as recipient role of selected template in your DocuSign account.</h6>
        </td>
      </tr>
      <tr valign="top">
        <th scope="row">
